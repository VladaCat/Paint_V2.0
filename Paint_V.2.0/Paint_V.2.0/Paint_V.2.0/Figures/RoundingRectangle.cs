...
{
    public class RoundingRectangle : AbstractFigure
    {
        public RoundingRectangle(int X, int Y, int Width, int Height, int MyColorARGB, int Thickness)
        {
            FigureType = EFigureType.RoundingRectangle;
